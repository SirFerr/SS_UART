...
HD_PWD='C:/Users/ursus/Documents/SS_UART/lab/lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SS_LR_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SS_LR_TOP.tcl
